    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                out.println("<h2>Valor Presente = "+vp+"</h1>");
                double j = Double.parseDouble(request.getParameter("j"));
                out.println("<h2>Juros (em %) = "+j+"</h1>");
                double n = Double.parseDouble(request.getParameter("n"));
                out.println("<h2>Tempo (em meses) = "+n+"</h1>");
                double vf = vp*(1+j*n);
                out.println("<h2>Valor Futuro = "+vf+"</h1>");
            }catch(Exception ex){
                out.println("<h2>Ocorreu um erro: "+ex.getLocalizedMessage()+"</h1>");
            }
            out.println("</body>");
            out.println("</html>");
        }
